...
Route::name('home.')->group(function () {
    ...
    Route::prefix('site')->name('site.')->group(function () {
        ...
        Route::post('store', [SiteController::class . 'store'])->name('store')->middleware('auth:socialite', 'clean.xss');
    });
    Route::middleware('auth:socialite')->group(function () {
        Route::get('socialiteUser/{socialiteUser}', [SocialiteUserController::class, 'show'])->name('socialiteUser.show');
...
Route::prefix('admin')->group(function () {
    ...
    Route::prefix('login')->group(function () {
        // 登录页面
        Route::get('index', [LoginController::class, 'index'])->middleware('guest:admin');
        // 退出
...
Route::prefix('admin')->middleware('auth:admin')->group(function () {
    ...
    Route::prefix('index')->group(function () {
        ...
        // 更新系统
        Route::get('upgrade', [IndexController::class ,'upgrade']);
        // For local testing only
        Route::get('loginUserForTest', [IndexController::class , 'loginUserForTest']);
    });
    // 文章管理
